...
电脑上,「三步成礼」下方是通栏的创作输入区——照片、一句话、裁剪都在这里;再往下左「微调」右「成品」,参数一动预览即变。手机上同一套分区:输入通栏置顶,下方左右双栏同屏,调参的每一刻结果都在眼前,不用上下翻页。配图主体太小?图片框右上角的「裁剪」随手一裁,原图始终保留、可反复重裁。「成品预览」右上角还能一键切换字画笔迹:系统黑体、杨任东竹石体(硬笔)、沐瑶随心手写体(中性笔),预览即换、导出同款。
...
字画正文另有三种画字字体可选(成品预览右上角):系统黑体 / 杨任东竹石体 / 沐瑶随心手写体。两种手写体以腾讯云 COS 加速域名为主源、本地副本兜底,点选时才按需加载,弱网或离线自动回退同源字体,不白屏。
